  ...
  return (
    <div className={theme === 'dark' ? 'dark' : ''}>
      <main className="min-h-screen bg-[#F4F6FA] dark:bg-[#0B0F19] text-slate-800 dark:text-slate-200 flex flex-col font-sans theme-transition relative overflow-hidden pb-12">
        ...
        <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-[#7c3aed]/5 rounded-full blur-[120px] pointer-events-none z-0" />
        ...
        <div className="max-w-5xl w-full mx-auto px-6 pt-12 md:pt-16 relative z-10 flex-1 flex flex-col justify-center gap-10">
          ...
          <div className="text-center space-y-3">
            <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white tracking-tight relative inline-block">
              Meet the Developer
              <div className="absolute bottom-[-6px] left-0 right-0 h-1 bg-gradient-to-r from-blue-500 to-[#7c3aed] rounded-full" />
            </h1>
              ...
              <ul className="space-y-3.5 text-xs font-bold text-slate-600 dark:text-slate-350 flex-1 flex flex-col justify-center">
                <li className="flex items-start gap-2.5">
                  ...
                  <p className="leading-relaxed">
                    Solely architected and engineered the Chronis behavioral analytics platform from scratch.
                  </p>
                </li>
                <li className="flex items-start gap-2.5">
        ...
        {/* ─── FOOTER ─── */}
        <footer className="w-full pt-16 text-center text-[10px] text-slate-400 dark:text-slate-500 font-medium relative z-20 theme-transition mt-auto pb-4">
          <div className="flex items-center justify-center gap-1.5 mb-1">
            <span>Made with</span>
            <Heart size={10} className="text-red-500 animate-pulse fill-red-500" />
            <span>by Palash Rai for Chronis Analytics</span>
          </div>
          <span>&copy; {new Date().getFullYear()} Chronis Analytics. All rights reserved.</span>
        </footer>
