    ...
    <div className="min-h-screen bg-background relative overflow-hidden flex flex-col items-center justify-center">
      ...
      <main className="z-10 text-center px-6 max-w-4xl mx-auto space-y-12">
        <div className="space-y-6">
          <h1 className="text-6xl md:text-8xl font-display font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">
            Chronis
          </h1>
          <p className="text-xl md:text-2xl text-textSecondary max-w-2xl mx-auto font-light">
        ...
        <div className="grid md:grid-cols-3 gap-8 pt-16">
          <div className="bg-card/50 p-6 rounded-2xl border border-white/5 backdrop-blur-sm">
